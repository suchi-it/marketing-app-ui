...
import {
  ...
  getallcollegesrecords,
  getcollegerecord,
  setStatusToDocumentListItem,
} from "src/services/ApiService";
import ZonalHead from "../AddCollege/ZonalHead";
...
// ApiService.uploadDocument(payload).then((res)=>{
//     console.log(res);
//   })
//   .catch((err)=>{
//     console.log(err);
//   });
  ...
  const TABLE_COLUMNS = [
    ...
    { id: "College Code", label: "College Code" },
    {
      id: "Date Of Visit",
      label: "Date Of Visit At",
      dataFormat: (cell) => {
